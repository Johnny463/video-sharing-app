...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const fetchVideos = async () => {
      try {
        // API endpoint would be: /api/videos
        ...
        // Mock data for MVP demo (remove in production)
        const mockVideos: Video[] = [
          {
            id: "1",
            title: "Amazing Sunset Timelapse",
            thumbnail: "https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=400&h=700&fit=crop",
          ...
          },
          {
            ...
            thumbnail: "https://images.unsplash.com/photo-1486496146582-9ffcd0b2b2b7?w=400&h=700&fit=crop",
            videoUrl: "https://sample-videos.com/video123/mp4/720/big_buck_bunny_720p_1mb.mp4",
            views: 34567,
